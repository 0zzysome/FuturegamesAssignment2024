...
namespace Mechadroids {
    ...
    public class EnemyEntityHandler : IEntityHandler {
        ...
        public void Initialize() {
            ...
            patrolState = new EnemyPatrolState(this, enemyReference);
            followState = new EnemyFollowState(this, enemyReference);
            // Initialize the default state (Idle State)
            idleState = new EnemyIdleState(this, enemyReference);
        ...
        public void Tick() {
            ...
            if(IsPlayerInDetectionRange()) {
                EntityState.Exit();
                EntityState = followState;
                EntityState.Enter();
            }
            else if(!IsPlayerInDetectionRange()) {
                EntityState.Exit();
                EntityState = patrolState;
                EntityState.Enter();
            }
